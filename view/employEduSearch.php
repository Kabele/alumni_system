...
<div class="pageContentTitle">Roger Williams University Alumni Network</div><br />
	<div class="pageContentSubTitle">Alumni Directory Search By Job</div><br />
    
<div class="formContent">

<form action="../searchByEduOutput.php" method="post" class="mainForm">
	<input type="hidden" name="action" value="eduSearch" />
	<fieldset>
		<legend>Advanced Search</legend>
		<ol>
			<li><label for="major">Major <em>*</em></label> <input name="major" id="major" /></li>
			<li><label for="minor">Minor <em>*</em></label> <input name="minor" id="minor" /></li>
			<li><label for="core">Core <em>*</em></label> <input name="core" id="core" /></li>
