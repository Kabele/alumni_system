...
<div class="mainContent">
    <p>Directories<p><hr /> 
    	<div class="pageTitle">Directories</div>

    <ul class="personalMenu">
    	<li><a href="directorySearch.php">Alumni Directory</a></li>
        <li><a href="employEduSearch.php">Search by Employment/Education</a></li>
        <li><a href="#">RWU Site Search</a></li>
    </ul>
