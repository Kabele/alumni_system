...
<div class="mainContent">
    <p>Personal<p><hr /> 
    	<div class="pageTitle">Personal and Account Information</div>

    <ul class="personalMenu">
    	<li><a href="change_username.php">Change Alumni Network Username</a></li>
        <li><a href="change_password.php">Change Alumni Network Password</a></li>
        <li><a href="alumni_update_account.php">Your Personal Information</a></li>
        <li><a href="uploadFile.php">Upload Images or Files</a></li>
    </ul>
