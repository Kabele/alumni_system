...
<div class="pageContentTitle">Roger Williams University Alumni Network</div><br />
	<div class="pageContentSubTitle">Password Update Form</div><br />
    
<div class="formContent">

<form action="../index.php" method="post" class="mainForm">
	<p>Please complete the password update form below. Mandatory fields marked <em>*</em></p>
	<fieldset>
		<legend>Change Password</legend>
		<ol>
        	<input type="hidden" name="action" value="changePassword" />
			<li><label for="username">Username <em>*</em></label> <input id="username" name="username" value="<?php echo $username; ?>" /></li>
			<li><label for="password">Password <em>*</em></label> <input id="password" name="password" type="password" /></li>
			<li><label for="newPassword">New Password <em>*</em></label> <input id="newPassword" name="newPassword" type="password"/></li>
			<li><label for="confirmPassword">Retype Password <em>*</em></label> <input id="confirmPassword" name="newPasswordConfirm" type="password"/></li>
			<li>
				<fieldset>
